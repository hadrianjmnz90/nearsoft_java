...
public class PriceSortTestImproved {
    ...
    public void verifyPricesSortingIsWorking() {
        ...
        homePage.getReturnDateField().sendKeys(Keys.ENTER);
...
//        homePage.getSearchButton().click();
        ...
        System.out.println("expected " + expectedPricesSorted);
        System.out.println("actual " + sortedPrices);
        Assert.assertEquals(sortedPrices, expectedPricesSorted);
    }
